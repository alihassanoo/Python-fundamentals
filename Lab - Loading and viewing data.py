...
gdp_change = df_gdp['change-current']# Create your dataframe with column change-curren
...
unemployment = df_unemployment['unemployment'] # Create your dataframe with column unemployment
...
title = "Ali's Analyzing US Economic Data and  Building a Dashboard" # Give your dashboard a string title
...
bucket_name = 'notebook-1' # Type your bucket name on IBM Cloud
